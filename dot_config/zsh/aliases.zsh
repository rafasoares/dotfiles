...
# skill.sh aliases
alias sk="npx skills"
alias ska="npx skills add"
alias skag="npx skills add -g"
alias skc="npx skills check"
alias skf="npx skills find"
alias skl="npx skills list"
alias sklg="npx skills list -g"
