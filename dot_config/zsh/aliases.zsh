...
alias aliases="edit_settings ~/.config/zs/aliases.zsh"
alias functions="edit_settings ~/.config/zs/functions.zsh"
...
alias chals="chezmoi edit --apply ~/.zsh/aliases.zsh"
alias chfn="chezmoi edit --apply ~/.zsh/functions.zsh"
