...
alias krc="kubectl exec -it deploy/platform -n platform -- bin/rails c"
alias krdb='k8s_rails_dbconsole deploy/platform -n platform -p platform -l 2'
...
alias chad="chezmoi apply --dry-run"
...
# skill.sh aliases
alias sk="pdx skills"
alias ska="pdx skills add"
alias skag="pdx skills add -g"
alias skc="pdx skills check"
alias skf="pdx skills find"
alias skl="pdx skills list"
alias sklg="pdx skills list -g"
alias skrm="pdx skills remove"
alias skrmg="pdx skills remove -g"
alias skup="pdx skills update"
