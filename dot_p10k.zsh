# Generated by Powerlevel10k configuration wizard on 2021-12-31 at 13:39 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_HOME_FOLDER_ABBREVIATION='%81F '
  ...
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/Developer/gapfish(|/*)'  GAPFISH  ''
    '~/Developer(|/*)'          DEV      ''
    '~/work(|/*)'               WORK     ''
    '~(|/*)'                    HOME     ''
    '*'                         DEFAULT  '')

  typeset -g POWERLEVEL9K_DIR_GAPFISH_VISUAL_IDENTIFIER_EXPANSION=$'%032F\uf739 '
  typeset -g POWERLEVEL9K_DIR_DEV_VISUAL_IDENTIFIER_EXPANSION=$'%032F\ue20f '
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=247
  typeset -g POWERLEVEL9K_RVM_BACKGROUND=233
  ...
  typeset -g POWERLEVEL9K_RVM_GEMSET_SEPARATOR_FOREGROUND=red
